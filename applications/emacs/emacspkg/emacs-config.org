...
* multiple-cursors
#+begin_src emacs-lisp :tangle yes
  (autoload-if-found '(mc/mark-next-like-this)
...
#+begin_src emacs-lisp :tangle yes
  ...
  (setq typst-preview-browser "zen-browser")
#+end_src
** terraform
#+begin_src emacs-lisp :tangle yes
...
#+begin_src emacs-lisp :tangle yes
  ...
  (with-eval-after-load 'org-roam
      (setq org-roam-directory  "~/obsidian-vault/zk")
  ...
  ,#+bibliography: ~/obsidian-vault/ref.bib")
          :unnarrowed t
          :jump-to-captured t)
           ("b" "book" plain "%?" :if-new
            (file+head "${slug}-%<%d-%m-%y>.org" "#+title: ${title}
  ,#+filetags: :reference:book:
  ,#+bibliography: ~/obsidian-vault/book.bib")
          :unnarrowed t
          :jump-to-captured t)
...
#+begin_src emacs-lisp :tangle yes
  ...
  (with-eval-after-load 'citar
    (setq citar-bibliography  '("~/obsidian-vault/ref.bib"))
