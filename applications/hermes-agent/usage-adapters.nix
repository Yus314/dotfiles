...
{
  home.file = {
    ".hermes/skills/hermes-usage-analysis-local/SKILL.md".source =
      ./profile-skills/default/hermes-usage-analysis-local/SKILL.md;
    ".hermes/profiles/career/skills/hermes-usage-analysis-local/SKILL.md".source =
    ...
    ".hermes/profiles/researcheval/skills/hermes-usage-analysis-local/SKILL.md".source =
      ./profile-skills/researcheval/hermes-usage-analysis-local/SKILL.md;
  };
}
