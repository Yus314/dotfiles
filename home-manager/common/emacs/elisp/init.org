...
#+begin_src emacs-lisp :tangle yes
  (leaf org
    ...
    :custom
    (org-todo-keywords
     . '((sequence  "TODO(t)" "WAIT(w)" "SOMEDAY(s)" "LEVEL1(1)" "|" "DONE(d)" "CANCEL(c)")
         )
     )
...
#+begin_src emacs-lisp :tangle yes
  (leaf org-super-agenda
    ...
    ("C-c a" . #'org-agenda)
    :custom
    (org-agenda-files . '("~/dropbox/inbox/inbox.org" "~/dropbox/habit.org"))
  ...
  (leaf org-capture
    ...
    (org-capture-templates
     . '(
  	  ...
  	  "* TODO %^{title}\n:PROPERTIES:\n:STYLE: habit\n:END:\n%?")
         ("1" "Level 1" entry (file+headline taskfile "プロジェクト" )
          "* LEVEL1 %^{title}[/]\n:PROPERTIES:\n:CATEGORY: %\\1\n:END:\n%?")
...
#+begin_src emacs-lisp :tangle yes
  (leaf gcal
    ...
    :require t gcal gcal-org
    :load-path "~/.emacs.d/el-get/gcal/"
    :custom
    (gcal-client-id . "1005172243429-37v4n4shbp9dinr7h7ki5elu98nko9h4.apps.googleusercontent.com")
    (gcal-client-secret . "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")
    :config
      (gcal-org-push-file
...
#+begin_src emacs-lisp :tangle yes
  (leaf citar
    :ensure t
    :custom
    (citar-bibliography . '("~/Documents/Zotero-test.bib"))
    )
#+end_src
* Git
** diff-hl
